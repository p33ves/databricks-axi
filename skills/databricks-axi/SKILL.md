...
metadata:
  hermes:
    tags: [databricks, spark, jobs, cluster, compute, start, stop, sql, warehouse, query, catalog, schema, table, unity, notebook, dbfs, volume, file, pipeline, dlt, lakeflow, serving, endpoint, model, hooks]
    category: data
---
