...
- Error, job log, SQL error detail, and pipeline event output redact
  token-shaped strings. File content (`workspace view`, `fs cat`) is
  returned as-is, unredacted, for data fidelity; it is not error or log
  output.
