...
const AVAILABLE_COMMANDS =
  "jobs (list, view, run, runs, logs, cancel), clusters (list, view, start, stop), sql (warehouses, exec, statement), catalog (catalogs, schemas, tables, table view), workspace (ls, view), fs (ls, cat), pipelines (list, view, start, stop, events), serving (list, view), setup (hooks), api";
